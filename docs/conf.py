...
htmlhelp_basename = 'pyficachedoc'
...
latex_documents = [
  (master_doc, 'pyficache.tex', u'pyficache Documentation',
...
man_pages = [
    (master_doc, 'pyficache', u'pyficache Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pyficache', u'pyficache Documentation',
   author, 'pyficache', 'Source-code file caching.',
   'Miscellaneous'),
]
